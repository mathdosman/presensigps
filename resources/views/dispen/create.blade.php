...
<div class="appHeader text-light" style="background-color: #26a29a">
    ...
    <div class="pageTitle">Form Pengajuan Dispensasi</div>
    <div class="right"></div>
</div>
<!-- appheader -->
@endsection
...
<div class="row" style="margin-top: 4rem">
    <div class="col">
        ...
        <div class="form-group">
            <input type="text" id="tgl_izin_dari" name="tgl_izin_dari" class="form-control datepicker" placeholder="Dispen dari tanggal" autocomplete="off">
        </div>
        <div class="form-group">
            <input type="text" id="tgl_izin_sampai" name="tgl_izin_sampai" class="form-control datepicker" placeholder="Dispen sampai tanggal" autocomplete="off">
        </div>
        <div class="form-group">
